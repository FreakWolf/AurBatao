  ...
  return (
    <Grid item xs={12} className={classes.root}>
      ...
      >
        ...
        <div className={classes.AurBatao}>
          <div>
            <h6 className={classes.AurBataoHeading}>{values.userName}</h6>
            <p className={classes.AurBataoTimming}>{time}</p>
          </div>

          <div className={classes.AurBataoText}>
            {values.text.split("\n").map((txt, idx) => (
              <div key={idx}>
